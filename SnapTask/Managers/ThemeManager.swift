...
struct Theme: Identifiable, Codable, Equatable {
    ...
    var cardBackground: Color {
        // Usa surfaceColor con un'opacità leggermente ridotta per un effetto più morbido
...
class ThemeManager: ObservableObject {
    ...
    static let allThemes: [Theme] = [
        ...
        Theme(
            ...
            isPremium: true,
            primaryColor: Color(red: 0.5, green: 0.2, blue: 0.8),  // Viola più acceso
            ...
            secondaryTextColor: Color(red: 0.9, green: 0.9, blue: 0.95)  // Grigio molto chiaro per migliore leggibilità
        ),
